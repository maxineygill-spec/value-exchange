...
const Debrief = ({ playerHand, debriefAnswers, setDebriefAnswers, onContinue }: DebriefProps) => {
    ...
    <div className="min-h-screen flex flex-col items-center px-4 py-12">
      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <label className={labelClass}>Did the negotiation change what you wanted or valued?</label>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <label className={labelClass}>What did you learn about your partner's values?</label>
          <textarea
            className={inputClass}
            rows={3}
